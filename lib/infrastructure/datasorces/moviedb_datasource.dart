...
class MoviedbDatasource extends MoviesDatasource {
  ...
  Future<Movie> getMovieById(String id) async {
    ...
    if (response.statusCode != 200) throw Exception('Movie with id: $id not foun');

    final movieDatails = MovieDetails.fromJson(response.data);
    final Movie movie = MovieMapper.movieDetailsToEntity(movieDatails);
